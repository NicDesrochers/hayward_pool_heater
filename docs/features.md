...
| PROTO-030 | Active command expectations | In Progress | Generated command bytes match known-safe expectations | Fan-control F01-F13 and CONFIG_1 R01/R02/R04-R07 byte contracts are covered; CONFIG_1 R01-R03 high setpoint encoding is regression-tested from issue #11; CONFIG_5 defrost eco/normal has fixture-backed live TX/echo evidence; broader active command expectations remain safety-sensitive |

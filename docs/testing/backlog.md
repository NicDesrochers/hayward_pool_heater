...
| TST-066 | Firmware web annotation/capture | Native C++ / Analysis tooling | Done | Firmware UI exposes browser-local annotation/export controls and capture tooling regenerates media-size screenshots | Native tests pin HTML controls; Python tests cover viewport parsing, dry-run paths, README image selection, and PNG validation |
